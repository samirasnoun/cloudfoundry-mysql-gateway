...
include_recipe 'cloudfoundry-common'
  ...
  Chef::Log.warn("Cloud controller found i am saving it")
 
  m_node = m_nodes.first
  
  node.set['cloudfoundry_mysql_service']['searched_data']['cloudfoundry_cloud_controller']['server']['api_uri'] = "" + m_node.ipaddress + ":" + m_node['cloudfoundry_cloud_controller']['server']['external_port'].to_s
  ...
  include_recipe "cloudfoundry-mysql-gateway::gateway"
